...
# Extracted from fla.ops.common.fused_recurrent and fla.ops.simple_gla.fused_recurrent
# for standalone testing of fused_recurrent_simple_gla kernel.
#
# This file contains:
# - fused_recurrent_fwd_kernel: Triton kernel for forward pass
# - fused_recurrent_bwd_kernel: Triton kernel for backward pass (optional)
# - fused_recurrent_fwd: Python wrapper for forward
# - FusedRecurrentFunction: torch.autograd.Function
# - fused_recurrent: Main interface
# - fused_recurrent_simple_gla: Simple GLA specific interface
...
# ============================================================================
# Triton Kernel: fused_recurrent_fwd_kernel
# ============================================================================
...
# ============================================================================
# Triton Kernel: fused_recurrent_bwd_kernel
# ============================================================================
...
def fused_recurrent(
    ...
    """
    Generic fused recurrent kernel interface.
    """
    if scale is None:
        scale = k.shape[-1] ** -0.5
...
def fused_recurrent_simple_gla(
    ...
    r"""
    Fused Recurrent Simple GLA kernel.
    
    This is the standalone implementation extracted from FLA for testing and optimization.
