...
# 期望的 MD5 校验值
EXPECTED_MD5_1="0f163ca3e79930b0ace29a4922c7c2ca"
EXPECTED_MD5_2="ccee649822dd697d272729a19bffd5aa"
...
download_with_retry() {
    ...
    while [[ $retry_count -lt $max_retries ]]; do
        ...
        if huggingface-cli download tpoisonooo/test --local-dir "$local_dir"; then
