...
python3 -m sglang.bench_one_batch_server --model-path /data/share/MiniCPM-SALA --base-url http://localhost:30100 --batch-size 16 --input-len 1024 --output-len 8 --profile-output-dir result --profile
"""
